  ...
  return (
    <AppShell
      ...
      action={
        <Link
          href="/projects"
          className="rounded-xl border border-slate-700 bg-slate-900 px-4 py-2.5 text-sm font-bold text-slate-200 hover:bg-slate-800"
        >
          ← Quay lại
        </Link>
      }
              ...
              <div className="text-right text-sm text-slate-400">
                <p>
                  ...
                  <span className="font-bold text-slate-200">
                    {details.createdByName || "Không rõ"}
                  </span>
                </p>
                <p className="mt-1">
          ...
          <div className="grid gap-6 xl:grid-cols-3">
            <section className="rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-600 p-6 text-white xl:col-span-1">
              ...
              <p className="mt-3 text-sm text-sky-100">
                {summary?.completedTasks ?? 0}/{summary?.totalTasks ?? 0} công
                việc đã hoàn thành
              </p>
            ...
            <section className="rounded-2xl border border-slate-800 bg-slate-900/80 p-6 xl:col-span-2">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {statuses.map((status) => {
                  ...
                  const pct = summary?.totalTasks
                    ? (count / summary.totalTasks) * 100
                    : 0;
                  return (
                    <div key={status}>
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="mt-2 text-xs text-slate-500">
                        {member.assignedTaskCount} công việc được giao
                      </p>
                    </div>
                  </div>
                ))}
