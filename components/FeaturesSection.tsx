const features = [
  {
    ...
    accent: "from-sky-500/15 to-cyan-500/5 text-sky-600 bg-sky-100",
  },
  {
    icon: "⏱️",
    ...
    accent: "from-emerald-500/15 to-teal-500/5 text-emerald-600 bg-emerald-100",
  },
  {
    icon: "✅",
    ...
    accent: "from-violet-500/15 to-fuchsia-500/5 text-violet-600 bg-violet-100",
  },
  {
    icon: "📊",
    ...
    accent: "from-amber-500/15 to-orange-500/5 text-amber-600 bg-amber-100",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {features.map((feature) => (
            ...
            >
              <div className={`mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${feature.accent} text-2xl`}>
                {feature.icon}
              </div>
        ...
        <div id="workflow" className="mt-16 rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              <div className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-sky-600">
                Quy trình nội bộ
              </div>
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Hệ thống được thiết kế cho các tổ chức cần đồng bộ giữa kế hoạch,
                thực thi, báo cáo và kiểm tra chất lượng trong một môi trường do
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                { step: "01", title: "Lập kế hoạch", text: "Khởi tạo dự án, gán owner, xác định mốc thời gian." },
                { step: "02", title: "Phân công", text: "Giao nhiệm vụ theo phòng ban và mức độ ưu tiên rõ ràng." },
                { step: "03", title: "Theo dõi", text: "Theo dõi tiến độ, báo cáo và điều chỉnh nhanh khi cần." },
              ].map((item) => (
                <div key={item.step} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <div className="text-xs font-bold uppercase tracking-[0.2em] text-sky-600">{item.step}</div>
        ...
        <div id="reporting" className="mt-16 rounded-[28px] border border-slate-200 bg-slate-900 p-8 text-white shadow-sm">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item.label} className="rounded-2xl border border-slate-700 bg-white/5 p-4 text-center">
